...
function CreateProperty() {
  ...
  const resetForm = () => {
    ...
    document.getElementById("property-video").value = "";
  };
  ...
  const handleSubmit = async (event) => {
    ...
    try {
      ...
      setSuccess(
        "Property created successfully. It is approved and can be displayed publicly."
      );
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Enter the main listing information.
                </p>
              </div>
            </div>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Add address, Google Maps location, and estimated cost.
                </p>
              </div>
            </div>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  Upload at least one image or a video. You can upload both.
                </p>
              </div>
            </div>
          ...
          <section className="rounded-xl border border-slate-200 bg-white p-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="mt-1 text-sm text-slate-500">
                  The contact person for this specific property.
                </p>
              </div>
            </div>
            ...
            <label className="mt-6 flex cursor-pointer items-center gap-3 rounded-lg border border-slate-200 bg-slate-50 p-4">
              <input
                type="checkbox"
                name="isFeatured"
              ...
              <span>
                ...
                <span className="mt-1 block text-sm text-slate-500">
                  Featured listings receive priority on the homepage.
                </span>
              </span>
            </label>
          </section>
